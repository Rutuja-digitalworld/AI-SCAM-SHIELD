...
import { analyzeContent } from './scamEngine';

import type { InputType, ScamAnalysis } from './types';
          ...
          <>
            ...
            <div className="text-center mb-8 pt-4">
              ...
              <p className="text-sm sm:text-base text-gray-500 dark:text-gray-400 max-w-lg mx-auto">
                Submit any suspicious message, screenshot, URL, or payment
                request. AI will analyze it and tell you the risk score, why
                it&apos;s suspicious, and what to do next.
              </p>
            </div>
            ...
            <div className="mt-8 flex items-center justify-center gap-2 text-xs text-gray-400 dark:text-gray-600">
              ...
              <span>
                We never ask for or store OTP, PIN, CVV, passwords, or card
                numbers.
              </span>
            </div>
          </>
